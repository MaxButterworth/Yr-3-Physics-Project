...
ax1.plot(wavelength, transmission, label='Spectrum', linewidth=3) # Plotting the sepctrum data and linear fit
...
ax2.plot(energy, ((grad * energy) + y_int), label='Linear Fit', color='orange', linewidth=3) # Plotting the linear fit
